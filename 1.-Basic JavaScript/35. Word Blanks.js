...
This sentence has three missing pieces- an adjective, a verb and an adverb, and we can add words of our 
choice to complete it. We can then assign the completed sentence to a variable as follows:
...
wordBlanks = "It was really " + myAdjective + myNoun + ", and we " +  + myVerb + myAdverb + ".";